...
// ----------------------------------------------------------------------
export default function IMRedeemRequestList() {
   ...
   const handleTransactionList = async (page) => {
      ...
      const response = await fetch(`http://103.13.206.208:1337/api/v1/transaction/interbank-redeem-request-list?page=${page}&perPage=15`, {
         method: 'GET',
         headers: {
               ...
               <TableContainer sx={{ minWidth: 800 }}>
                  <Table>
                     <UserListHeadWithoutCheckbox
                        ...
                        rowCount={transactionList?.data?.redeemRequestList?.length}
                        numSelected={selected.length}
                        onRequestSort={handleRequestSort}
                        onSelectAllClick={handleSelectAllClick}
                     />
                     <TableBody>
                        {transactionList?.data?.redeemRequestList?.map((row) => {
